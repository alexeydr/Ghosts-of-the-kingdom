...
// End Cross Module References
	...
	struct Z_Construct_UClass_UAvailableMovesStruct_Statics
	{
		...
		static const UECodeGen_Private::FStructPropertyParams NewProp_AvailableMoves_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_AvailableMoves_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_AvailableMoves;
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves_Inner = { "AvailableMoves", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves_MetaData[] = {
		{ "Category", "AvailableMovesStruct" },
		{ "ModuleRelativePath", "Public/CustomMovementComponent.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves = { "AvailableMoves", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAvailableMovesStruct, AvailableMoves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAvailableMovesStruct_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAvailableMovesStruct_Statics::NewProp_AvailableMoves,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject_Source_MyProject_Public_CustomMovementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAvailableMovesStruct, UAvailableMovesStruct::StaticClass, TEXT("UAvailableMovesStruct"), &Z_Registration_Info_UClass_UAvailableMovesStruct, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAvailableMovesStruct), 3420540492U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject_Source_MyProject_Public_CustomMovementComponent_h_491465138(TEXT("/Script/MyProject"),
