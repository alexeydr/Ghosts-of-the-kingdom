...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyProjectGameModeBase_Statics::NewProp_TileSize_MetaData[] = {
		{ "Category", "MyProjectGameModeBase" },
		{ "ModuleRelativePath", "MyProjectGameModeBase.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AMyProjectGameModeBase_Statics::NewProp_TileSize = { "TileSize", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMyProjectGameModeBase, TileSize), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_AMyProjectGameModeBase_Statics::NewProp_TileSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMyProjectGameModeBase_Statics::NewProp_TileSize_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyProjectGameModeBase_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyProjectGameModeBase_Statics::NewProp_TileSize,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject_Source_MyProject_MyProjectGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyProjectGameModeBase, AMyProjectGameModeBase::StaticClass, TEXT("AMyProjectGameModeBase"), &Z_Registration_Info_UClass_AMyProjectGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyProjectGameModeBase), 3262260121U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject_Source_MyProject_MyProjectGameModeBase_h_2039109571(TEXT("/Script/MyProject"),
